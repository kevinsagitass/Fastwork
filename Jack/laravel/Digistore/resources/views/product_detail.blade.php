...
@section('content')
<div class="container bg-white" style="opacity: 90%">
    <div class="row p-3" style="height: fit-content; border: 1px solid black;">
        <div class="col-sm-12 col-md-6 text-center" style="height: fit-content; border-right: 1px solid black;">
            <img src="{{ url('storage/products/' . $product->image) }}" alt="" style="max-width: 100%; max-height: 75%;" />
        </div>
        <div class="col-sm-12 col-md-6" style="height: fit-content;">
            ...
            <p>She said that its her first time oh yeyee</p>
            <p>Immadicted to </p>
            <h1>piercings </h1>
            <p>Real deep like the doctor scores</p>
            <p>Never wanna begin icycle</p>
            <p>I K</p>
