...
<div class="container">
    ...
    <form action="{{ url('product/search') }}" method="get">
        <div class="row">
            <div class="col-sm-8 col-md-11 mt-5">
                <div class="input-group">
                    ...
                    <span class="input-group-append">
                        <button class="btn btn-outline-secondary border-left-0 border text-black bg-white" type="button" onclick="document.getElementById('search').value = ''">
                            &#x2715
                        </button>
                    </span>
                </div>
            </div>
            <div class="col-sm-4 col-md-1 mt-5">
